...
var TextAnim = function TextAnim(_ref) {
  ...
  return React.createElement("div", null, React.createElement("div", {
    ...
    style: {
      ...
      backgroundImage: type === 'gradientone' ? "linear-gradient(\n            -225deg,\n            " + grad1 + " 0%,\n            " + grad2 + " 29%,\n            " + grad3 + " 67%,\n            " + grad4 + " 100%\n          )" : 'none',
      marginTop: top + "rem",
      marginLeft: left + "rem",
...
var Special = function Special(_ref) {
  var name = _ref.name,
      type = _ref.type,
      count = _ref.count,
      color = _ref.color,
      ...
      left = _ref.left,
      bottom = _ref.bottom;
  var input = Array.from(name);
  var myspan = input.map(function (inputs) {
...
//# sourceMappingURL=text-animations-react.cjs.development.js.map
